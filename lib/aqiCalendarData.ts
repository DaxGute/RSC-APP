import { aqiCategory, pm25ToAqi } from './aqiUtils';
import { fetchDailySensorAqiCalendarRows, fetchDailySensorAqiCalendarRowsForMonth } from './fetchAirQuality';
import { dateKeyLocal } from './aqiTenMinuteAggregation';
